...
interface MiniSupportContract
{
     ...
     */
    public function getPurchaseRequestData(array $params = []);
     ...
     * lifecycle: 退款前处理请求参数
     */
    public function getRefundRequestData(array $params);
     ...
     */
    public function getCompletePurchaseRequestData(array $params = []);
     ...
     * 获取商户订单号
     */
    public function getNotifyOrderNum(array $params);

    /**
     * 获取支付平台订单号
     */
    public function getNotifyT3dOrderNum(array $params);
